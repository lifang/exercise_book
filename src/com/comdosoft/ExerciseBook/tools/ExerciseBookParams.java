...
public interface ExerciseBookParams {
	...
	// public final static String QUESTION_DICTATION_ERROR_MES =
	// "\t有几个词是不是还没有听出来呢?看看下面这些词,里面有你没有听出来的词哦,试着再听听,把它填进去吧!";
	// public final static String QUESTION_DICTATION_ERROR_MES_ONE =
	// "\t橙色的单词是你只拼对了一半,它下面才是正确的拼写,请务必住哦!";
	// public final static String QUESTION_DICTATION_ERROR_MES_TWO =
	// "\t橙色的单词是你只拼对了一半,它下面才是正确的拼写,请务必记住哦!另外,看看下面这些词,里面有你没有听出来的词哦,试着再听听,把它填进去吧!";
	//
